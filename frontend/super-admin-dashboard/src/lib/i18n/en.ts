...
export const en: TranslationMessages = {
  ...
  nav: {
    dashboard: 'Dashboard',
    dashboardDesc: 'Integrated dashboard and real-time status',
    partners: 'Partners',
    partnersDesc: 'Partner management',
    settings: 'Settings',
    ...
    partnerOnboardingDesc: 'Partner onboarding management',
    integratedDashboard: 'Integrated Dashboard',
    integratedDashboardDesc: 'Integrated operations dashboard',
