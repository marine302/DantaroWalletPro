...
from app.models.external_energy import ExternalEnergyProvider, ExternalEnergyPurchase, EnergyProviderType, PurchaseStatus
from app.models.partner_onboarding import PartnerOnboarding, OnboardingStatus
        ...
        try:
            ...
            for i in range(20):
                audit_log = AuditLog(
                    ...
                    action=random.choice(["LOGIN", "WITHDRAWAL", "TRANSFER", "DEPOSIT"]),
            ...
            for i in range(10):
                activity = SuspiciousActivity(
                    user_id=random.randint(1, 5),
                    activity_type=random.choice(["LARGE_TRANSACTION", "RAPID_TRANSACTIONS", "UNUSUAL_PATTERN"]),
        ...
        try:
            ...
            for i in range(15):
                ...
                purchase = ExternalEnergyPurchase(
                    ...
                    total_cost=Decimal(str(random.randint(10000, 100000))) * price_per_energy,
                    purchase_type=random.choice(["manual", "auto"]),
                    status=random.choice([PurchaseStatus.COMPLETED, PurchaseStatus.PENDING, PurchaseStatus.FAILED]),
        ...
        try:
            ...
            for i in range(10):
                partners_data.append({
                    ...
                    "status": random.choice([OnboardingStatus.PENDING, OnboardingStatus.REGISTRATION, OnboardingStatus.COMPLETED]),
            ...
            for partner_data in partners_data:
                partner = PartnerOnboarding(
                    ...
                    progress_percentage=partner_data["current_step"] * 16,  # 6단계이므로 100/6 ≈ 16
