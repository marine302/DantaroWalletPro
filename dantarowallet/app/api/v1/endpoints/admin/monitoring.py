...
from app.schemas.monitoring import (
    SystemMetrics, SystemHealth, PartnerRanking, 
    ...
    try:
        ...
        analytics = {
            ...
            "endpoint_popularity": [
                ...
                {"endpoint": "/api/v1/transactions", "calls": 4321, "success_rate": 97.8},
...
async def get_uptime_analytics(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get uptime analytics: {str(e)}")
