...
async def create_fee_config(
    ...
    try:
        ...
        config = await fee_service.create_fee_config(
            fee_data=fee_data, admin_id=admin_id
        )
        ...
        raise HTTPException(
            status_code=500, detail="수수료 설정 생성 중 오류가 발생했습니다."
        )
...
async def update_fee_config(
    ...
    try:
        ...
        config = await fee_service.update_fee_config(
            config_id=config_id, update_data=update_data, admin_id=admin_id
        )
        ...
        raise HTTPException(
            status_code=500, detail="수수료 설정 수정 중 오류가 발생했습니다."
        )
...
async def calculate_fee(
    ...
    try:
        ...
        logger.info(
            f"관리자 {current_admin.id}가 수수료 계산: {calculation_request.amount}"
        )
        return result
        ...
        raise HTTPException(
            status_code=500, detail="수수료 계산 중 오류가 발생했습니다."
        )
...
async def get_partner_revenue_stats(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="파트너 수수료 통계 조회 중 오류가 발생했습니다."
        )
...
async def get_total_revenue_stats(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="전체 수수료 수익 통계 조회 중 오류가 발생했습니다."
        )
