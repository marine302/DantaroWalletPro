...
async def get_system_health(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="시스템 헬스 상태 조회 중 오류가 발생했습니다."
        )
...
async def get_system_metrics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="시스템 메트릭 조회 중 오류가 발생했습니다."
        )
...
async def disable_maintenance_mode(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="점검 모드 비활성화 중 오류가 발생했습니다."
        )
