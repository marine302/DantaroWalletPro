...
async def execute_optimization_action(
    ...
    try:
        ...
        # 최적화 작업 실행
        result = await optimization_manager.apply_manual_optimization(action_type, params)
...
async def optimization_health_check(
    ...
    try:
        health_status = {
            ...
            "redis_connection": optimization_manager.db_optimizer.redis_client is not None,
        }
