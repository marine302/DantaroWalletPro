...
from app.schemas.fee_policy import (
    ...
    # 에너지 정책 스키마
    PartnerEnergyPolicyCreate, PartnerEnergyPolicyUpdate, PartnerEnergyPolicyResponse,
    
    # 사용자 등급 스키마
    UserTierCreate, UserTierUpdate, UserTierResponse
)
...
@router.post("/partners/{partner_id}/fee-policy", response_model=PartnerFeePolicyResponse)
...
@router.get("/partners/{partner_id}/fee-policy", response_model=Optional[PartnerFeePolicyResponse])
...
@router.put("/partners/{partner_id}/fee-policy", response_model=PartnerFeePolicyResponse)
...
@router.post("/partners/{partner_id}/calculate-fee", response_model=FeeCalculationResponse)
...
@router.post("/partners/{partner_id}/withdrawal-policy", response_model=PartnerWithdrawalPolicyResponse)
...
@router.get("/partners/{partner_id}/withdrawal-policy", response_model=Optional[PartnerWithdrawalPolicyResponse])
...
@router.put("/partners/{partner_id}/withdrawal-policy", response_model=PartnerWithdrawalPolicyResponse)
...
@router.post("/partners/{partner_id}/energy-policy", response_model=PartnerEnergyPolicyResponse)
...
@router.get("/partners/{partner_id}/energy-policy", response_model=Optional[PartnerEnergyPolicyResponse])
...
@router.put("/partners/{partner_id}/energy-policy", response_model=PartnerEnergyPolicyResponse)
...
@router.post("/partners/{partner_id}/users/{user_id}/tier", response_model=UserTierResponse)
...
@router.get("/partners/{partner_id}/users/{user_id}/tier", response_model=Optional[UserTierResponse])
...
@router.put("/partners/{partner_id}/users/{user_id}/tier", response_model=UserTierResponse)
