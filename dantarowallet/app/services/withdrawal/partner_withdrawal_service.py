...
from app.models.withdrawal_policy import (
    PartnerWithdrawalPolicy, WithdrawalApprovalRule, WithdrawalWhitelist
)
...
class PartnerWithdrawalService:
    ...
    async def get_approval_rules(
        ...
        """승인 규칙들을 조회합니다."""
        return await self.approval_engine.get_approval_rules(
    ...
    async def get_whitelist_entries(
        ...
        """화이트리스트 항목들을 조회합니다."""
        return await self.policy_manager.get_whitelist_entries(
            policy_id, active_only
        )
