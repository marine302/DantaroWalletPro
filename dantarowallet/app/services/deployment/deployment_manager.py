...
class DeploymentManager:
    ...
    def _prepare_deployment_config(self, partner: Partner, deployment_id: str) -> Dict[str, Any]:
        """배포 설정 준비"""
        return {
            "partner_id": safe_str(partner.id),
            "deployment_id": deployment_id,
    ...
    def _update_partner_deployment_config(self, partner_id: str, deployment_config: Dict[str, Any]) -> None:
        """파트너 배포 설정 업데이트"""
        update_query = (
            update(Partner)
