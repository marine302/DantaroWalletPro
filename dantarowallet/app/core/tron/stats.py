...
class TronNetworkStatsService(TronNetworkService):
    ...
    async def get_network_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            network_stats = {
                "block_height": latest_block.get("block_header", {})
                .get("raw_data", {})
                .get("number", 0),
                "block_timestamp": latest_block.get("block_header", {})
                .get("raw_data", {})
                .get("timestamp", 0),
                "witness_count": len(
                ...
                "node_version": node_info.get("configNodeInfo", {}).get(
                    "codeVersion", "unknown"
                ),
                "total_transaction": node_info.get("machineInfo", {}).get(
            ...
            logger.info(
                f"Network stats retrieved for block #{network_stats['block_height']}"
            )
