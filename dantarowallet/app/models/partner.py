...
class Partner(Base):
    ...
    energy_usage_history = relationship("PartnerEnergyUsageHistory", back_populates="partner", cascade="all, delete-orphan")
    fee_revenues = relationship("PartnerFeeRevenue", back_populates="partner", cascade="all, delete-orphan")
    fee_config_history = relationship("PartnerFeeConfigHistory", back_populates="partner", cascade="all, delete-orphan")
