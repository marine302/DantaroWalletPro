...
def safe_dict(value: Any, default: Dict[str, Any] = None) -> Dict[str, Any]:
    """안전한 dict 변환"""
    if default is None:
        default = {}
...
class DeploymentService:
    ...
    async def get_onboarding_steps(self, partner_id: str) -> List[OnboardingStep]:
        ...
        try:
            ...
            steps = [
                OnboardingStep(
                    step_name="partner_registration",
                ...
                OnboardingStep(
                    step_name="contract_signing",
                    description="Digital contract signing and terms agreement",
                    status="completed",
                    estimated_duration=15,
                    dependencies=["partner_registration"]
                ),
                OnboardingStep(
                    step_name="technical_setup",
        ...
        try:
            ...
            templates = [
                ...
                PartnerTemplate(
                    ...
                    environment_variables={"ENV": "production", "PREMIUM": "true"},
